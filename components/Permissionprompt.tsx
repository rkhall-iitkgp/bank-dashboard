    ...
    return (
        ...
        >
            <div className={classes.topheading}>
                <div className={classes.cancel} onClick={() => SetIsPermissionPopUpOpen(false)}>Cancel</div>
                    ...
                    <div className={classes.forminside}>
                        <div className={classes.beficiaryformcontainer}>
                            ...
                            <div className={classes.description}>
                                We are unable to process your transaction request as you have not provided permission to access your transaction data.
                            </div>
                            <div className={classes.titlebold}>Please click the button below to proceed to your profile page where you can provide your consent.</div>
                            <Group mt="lg">
