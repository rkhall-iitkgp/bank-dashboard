...
const Dashboard = () => {
  ...
  const AccountComponent = (props: { label: string, ref: any }) => {
    return (
      <Group ref={props.ref} style={{ borderRadius: "30px", cursor: "pointer", padding: "0.8rem 1.2rem" }} >
        <Image
      ...
      <Group className="dashboard-group" align={'flex-start'} pt={20}>
        <Stack className="left-side" mx={20}>
          <Group my={10} style={{ justifyContent: 'space-between' }}>
            ...
            <Group style={{ borderRadius: "30px", cursor: "pointer", boxShadow: "0px 4px 20px rgba(0, 0, 0, 0.1)", padding: "0.8rem 1.2rem" }} >
              <Select
                icon={<Image
                  src={'icons/sbilogo.png'}
                  height={'28px'}
                  ...
                  alt="sbi-logo"
                />}
                placeholder='bank account' data={ACCOUNTFAKEDATA} />
            </Group>
          </Group>
