        ...
        <Group className="dashboard-group" align={"flex-start"} pt={20}>
            <Stack className="left-side" mx={20}>
                ...
                <Group style={{ justifyContent: "space-between" }}>
                    <CashCard n={5} type={"deposit"} limit={depositLimit} setLimit={setDepositLimit} />
                    <CashCard n={10} type={"withdrawl"} limit={withdrawlLimit} setLimit={setWithdrawlLimit} />
                </Group>
            ...
            <Stack className="right-side">
                <Group mx={20}>
                    <Text fz={35} fw={700} ff="Montserrat">Welcome Back,</Text>
                    <Text fz={35} fw={700} c={"#0062D6"} ff="Montserrat">Bill Gates!</Text>
                </Group>
