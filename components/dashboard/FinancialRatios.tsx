    ...
    return (
        <Card radius={"lg"} style={{ flex: 3 }} mx={20} p={0}>
            <Card.Section h={70} bg={"#DDEDFF"} pt={25}>
                <Text c={"#0052B3"} fw={500} ff="Montserrat" fz={30} align="center" style={{ lineHeight: "1.3" }}>Financial Ratios</Text>
            </Card.Section>
            <Group mx='auto' py={10} h={170} noWrap={false} align="flex-start" style={{ flexWrap: "wrap", overflow: 'auto', flex: 1 }}>
