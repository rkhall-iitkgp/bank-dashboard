...
interface Props {
  ...
  isKycPermissionPopUpOpen: boolean
}
export function KycPermissionFormPopup({
  ...
  return (
    <Modal
      ...
      opened={isKycPermissionPopUpOpen}
      onClose={() => SetIsKycPermissionPopUpOpen(false)}
      centered
      radius="lg"
      size="auto"
      padding={0}
    >
      <div className={classes.topheading}>
        <div
          ...
          onClick={() => SetIsKycPermissionPopUpOpen(false)}
        >
          Cancel
        </div>
