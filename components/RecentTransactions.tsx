    ...
    <Container>
      ...
      <BodyContent>
        {transactions.map((transaction) => {
          ...
          if (transaction.description.length > 12) descriptionShort += '...'
          return (
            <Card key={transaction.date}>
              <Col style={{ flex: '4', paddingLeft: '10px' }}>
                ...
                <DescriptionFull>{transaction.description}</DescriptionFull>
              </Col>
              <Col
                style={{ flex: '1.5', color: dict.color, alignItems: 'center' }}
              >
                <span>
